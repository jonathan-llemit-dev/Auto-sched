            ...
            <div class="bg-white sm:rounded-xl relative sm:shadow-md w-full h-full sm:block flex flex-col flex-wrap justify-between">
                <div class="">    
                    ...
                    <div>
                        ...
                        <div class="bg-b6 w-full p-3 flex items-center justify-center">
                            <p class="text-white text-lg font-normal text-center">COORDINATOR'S LOG IN FORM</p>
                        </div>
                    </div>
        
                    <x-splade-form action="{{ route('coor.signin') }}">
                        <div class="m-7">
                            <div class="w-full">
                ...
                @if (Route::has('coor.password.request'))
