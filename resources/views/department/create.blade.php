        ...
        <nav class="w-full hidden sm:flex justify-between items-center p-3 transition-all ease-in-out nav absolute top-0">
            <div class="flex items-center">
                <div class="pr-3 border-r border-gray-300">
                    <Link class="flex items-center justify-center gap-3 blue-btn squared-btn border-2" href="{{ route('department.index') }}">
            ...
            <div class="bg-white sm:rounded-xl relative sm:shadow-md w-full h-full">
                ...
                <div class="sm:hidden">
                    <div class="bg-b6 w-full p-3 flex sm:px-5 items-center justify-center">
                        <p class="text-white sm:text-lg text-sm font-normal text-center">ADD DEPARTMENT</p>
                    </div>
                </div>
                ...
                <div class="p-7 pt-2">
                    <x-splade-form action="{{ route('department.store') }}" class="bg-white rounded-md">
                        <div>
                            <div class="relative border-gray-200 border rounded-md p-6 mt-5 input-cntnr">
                                ...
                                <div class="w-full">
                                    <div class="">
                                        <x-splade-input class="input blue-inpt" id="deptCode" type="text" name="deptCode" label="Department Code" required autofocus />
                                    </div>
                    
                                    <div class="mt-4">
                                        <x-splade-input class="input blue-inpt" id="deptName" type="text" name="deptName" label="Department Name" required />
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="rounded-btn-i blue-btn-i mt-8 flex items-center justify-center">
                            <x-splade-submit :label="__('ADD DEPARTMENT')" />
                        </div>
                    </x-splade-form>
                </div>
            </div>
