<x-prof-guest-layout>
    <div class="bg-white sm:rounded-xl relative sm:shadow-md lg:w-tabw w-full">
        <div class="sm:hidden flex items-start p-5 h-fit transition-all ease-in-out navback">
            <Link class="flex items-center justify-center gap-3" href="{{ route('prof.login') }}">
        ...
        <div class="sm:hidden">
            ...
            <div class="bg-b6 w-full p-4 flex items-center justify-center">
                <p class="text-white text-lg font-normal text-center">PROFESSOR'S REGISTRATION FORM</p>
            </div>
        </div>

        <div class="hidden sm:block px-3 py-1 border-l-4 border-l-b6 m-7 mb-0">
            <p class="text-lg text-b6">
                PROFESSOR'S REGISTRATION FORM
            </p>
        </div>

        <x-splade-form action="{{ route('prof.register') }}" class="space-y-4">
            <div class="m-7 mt-2">
                ...
                <div class="flex items-center w-full justify-center sm:justify-end">
                    <div class="hidden sm:flex flex-wrap items-center text-xs0 mr-4">
                        ...
                        <Link class="sm:text-blc1 text-b6 text-xs mr-2 transition-all ease-in-out hover:text-b6" href="{{ route('prof.login') }}">
                            Log In Here.
                        </Link>
                    </div>
