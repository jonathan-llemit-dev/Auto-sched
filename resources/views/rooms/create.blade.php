        ...
        <nav class="w-full hidden sm:flex justify-between items-center p-3 transition-all ease-in-out nav absolute top-0">
            <div class="flex items-center">
                <div class="pr-3 border-r border-gray-300">
                    <Link class="flex items-center justify-center gap-3 blue-btn squared-btn border-2" href="{{ route('rooms.index') }}">
                        <i class="text-sm fa-solid fa-door-open"></i>
                        <p class="text-xs text-center">ROOMS</p>
                    </Link>
                </div>
        ...
        <x-splade-modal class="rounded-xl p-0 modal blue-btn-x" max-width="md">
            <div class="bg-white sm:rounded-xl relative sm:shadow-md w-full h-full">
                <div class="sm:hidden flex items-start p-5 h-fit transition-all ease-in-out navback">
                    <Link class="flex items-center justify-center gap-3" href="{{ route('rooms.index') }}">
                        <i class="text-sm fa-solid fa-door-open"></i>
                        <p class="text-xs text-center">Rooms</p>
                    </Link>
                </div>
                ...
                <div class="sm:hidden">
                    <div class="bg-b6 w-full p-3 flex sm:px-5 items-center justify-center">
                        <p class="text-white sm:text-lg text-sm font-normal text-center">ADD ROOM</p>
                    </div>
                </div>
                ...
                <div class="p-7 pt-2">
                    <x-splade-form action="{{ route('rooms.store') }}" class="bg-white rounded-md">
                        <div>
                            <div class="relative border-gray-200 border rounded-md p-6 mt-5 input-cntnr">
                                ...
                                <div class="w-full">
                                    <div class="">
                                        <x-splade-input class="input blue-inpt" id="roomNumber" type="text" name="roomNumber" :label="__('Room Number')" required autofocus />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="relative border-gray-200 border rounded-md p-6 mt-5 input-cntnr">
                                ...
                                <div class="w-full">
                                    <div class="">
                                        <x-splade-select class="drop-down blue-inpt input" placeholder="Select the Department" id="roomDepartment" name="roomDepartment" :label="__('Department')" required :options="$department" />
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="rounded-btn-i blue-btn-i mt-8 flex items-center justify-center">
                            <x-splade-submit :label="__('ADD ROOM')" />
                        </div>
                    </x-splade-form>
                </div>
            </div>
