...
class CoorDashboardController extends Controller
{
    public function create(){

        // getting coordinator id
        $schName = Auth::user()->coorSchool;
        ...
        return view('coor.dashboard', compact('subjects', 'departments', 'courses', 'professors', 'rooms'));
